...
echo Html::submitButton('', ['class' => 'btn', 'name' => 'remove_ban', 'value' => $model->id, 'style' => 'border: 0px solid transparent;width:92px;height:32px;background: url(img/lift_ban.png)']);
echo "</div></div></div>";